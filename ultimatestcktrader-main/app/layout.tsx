...
const TrustedPartners = () => {
  const partners = [
    {
      name: "Partner 1",
      logo: "https://i.ibb.co/jPQvhfft/download-3.jpg",
    },
    {
      name: "Partner 2",
      logo: "https://i.ibb.co/vC8WPJQ3/download-3.png",
    },
    {
      name: "Partner 3",
      logo: "https://i.ibb.co/twJvkjMX/download-2.png",
    },
    {
      name: "Partner 4",
      logo: "https://i.ibb.co/xqrVqfqS/download-4.jpg",
    },
    {
      name: "Partner 5",
      logo: "https://i.ibb.co/23BpxHYd/download-1.png",
    },
    {
      name: "Partner 6",
      logo: "https://i.ibb.co/W4MfX3GG/download.png",
    },
  ]
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 items-center">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="flex items-center justify-center p-6 bg-slate-900 rounded-lg border border-slate-700 hover:border-orange-500 transition-all hover:shadow-lg hover:shadow-orange-500/20 aspect-video"
            >
              <img
...
const LiveMarketData = () => (
  <section className="bg-slate-900 py-20 px-4">
    <div className="container mx-auto">
      ...
      <div className="bg-slate-800 rounded-lg p-4 w-full overflow-hidden">
...
const TrendingStocks = () => (
  <section className="bg-slate-800 py-20 px-4">
    <div className="container mx-auto">
      ...
      <div className="bg-slate-900 rounded-lg p-4 w-full overflow-hidden">
        <TradingViewHotlists />
      </div>
    </div>
  </section>
